...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
		...
		<link rel="icon" href="../view/html/jsp/favicon.ico?" type="image/x-icon">
		
		<!-- vector map CSS -->
		<link href="../view/html/vendors/bower_components/jasny-bootstrap/dist/css/jasny-bootstrap.min.css" rel="stylesheet" type="text/css"/>
	...
	<body>
		...
		<div class="wrapper theme-1-active pimary-color-pink">
			...
			<nav class="navbar navbar-inverse navbar-fixed-top">
				<div class="mobile-only-brand pull-left">
					<div class="nav-header pull-left">
						<div class="logo-wrap">
							<a href="index.html">
								<img class="brand-img" src="../view/html/img/logo.png" alt="brand"/>
				...
				<div id="mobile_only_nav" class="mobile-only-nav pull-right">
					<ul class="nav navbar-right top-nav pull-right">
									...
									<ul class="pa-20">
										...
										<li class="col-md-6 col-xs-12 preview-carousel">
											...
											<div class="product-carousel owl-carousel owl-theme text-center">
												<a href="#">
													<img src="../view/html/img/chair.jpg" alt="chair">
													<span>Circle chair</span>
												</a>
												<a href="#">
													<img src="../view/html/img/chair2.jpg" alt="chair">
													<span>square chair</span>
												</a>
												<a href="#">
													<img src="../view/html/img/chair3.jpg" alt="chair">
													<span>semi circle chair</span>
												</a>
												<a href="#">
													<img src="../view/html/img/chair4.jpg" alt="chair">
								...
								<li>
									<div class="streamline message-nicescroll-bar">
										...
										<div class="sl-item">
											<a href="javascript:void(0)">
												<div class="sl-avatar">
													<img class="img-responsive" src="../view/html/img/avatar.jpg" alt="avatar"/>
												</div>
												<div class="sl-content">
						...
						<li class="dropdown auth-drp">
							<a href="#" class="dropdown-toggle pr-0" data-toggle="dropdown"><img src="../view/html/img/user1.png" alt="user_auth" class="user-auth-img img-circle"/><span class="user-online-status"></span></a>
				...
				<ul class="nav navbar-nav side-nav nicescroll-bar">
					...
					<li>
						<div class="user-profile text-center">
							<img src="../view/html/img/user1.png" alt="user_auth" class="user-auth-img img-circle"/>
													...
													<ul class="chat-list-wrap">
														<li class="chat-list">
															<div class="chat-body">
																<a href="javascript:void(0)">
																	<div class="chat-data">
																		<img class="user-img img-circle"  src="../view/html/img/user.png" alt="user"/>
																		<div class="user-data">
																...
																<a href="javascript:void(0)">
																	<div class="chat-data">
																		<img class="user-img img-circle"  src="../view/html/img/user1.png" alt="user"/>
																		<div class="user-data">
																...
																<a href="javascript:void(0)">
																	<div class="chat-data">
																		<img class="user-img img-circle"  src="../view/html/img/user2.png" alt="user"/>
																		<div class="user-data">
																...
																<a href="javascript:void(0)">
																	<div class="chat-data">
																		<img class="user-img img-circle"  src="../view/html/img/user3.png" alt="user"/>
																		<div class="user-data">
																			<span class="name block capitalize-font">Mitsuko Heid</span>
																			<span class="time block truncate txt-grey">Im thankful.</span>
																		</div>
																		<div class="status online"></div>
																		<div class="clearfix"></div>
																	</div>
																...
																<a href="javascript:void(0)">
																	<div class="chat-data">
																		<img class="user-img img-circle"  src="../view/html/img/user4.png" alt="user"/>
																		<div class="user-data">
															...
															<ul class="nicescroll-bar pt-20">
																<li class="friend">
																	<div class="friend-msg-wrap">
																		<img class="user-img img-circle block pull-left"  src="../view/html/img/user.png" alt="user"/>
										...
										<div class="set-height-wrap">
											<div class="streamline message-box nicescroll-bar">
												<a href="javascript:void(0)">
													<div class="sl-item unread-message">
														<div class="sl-avatar avatar avatar-sm avatar-circle">
															<img class="img-responsive img-circle" src="../view/html/img/user.png" alt="avatar"/>
														</div>
														<div class="sl-content">
												...
												<a href="javascript:void(0)">
													<div class="sl-item">
														<div class="sl-avatar avatar avatar-sm avatar-circle">
															<img class="img-responsive img-circle" src="../view/html/img/user1.png" alt="avatar"/>
														</div>
														<div class="sl-content">
												...
												<a href="javascript:void(0)">
													<div class="sl-item">
														<div class="sl-avatar avatar avatar-sm avatar-circle">
															<img class="img-responsive img-circle" src="../view/html/img/user2.png" alt="avatar"/>
														</div>
														<div class="sl-content">
												...
												<a href="javascript:void(0)">
													<div class="sl-item unread-message">
														<div class="sl-avatar avatar avatar-sm avatar-circle">
															<img class="img-responsive img-circle" src="../view/html/img/user3.png" alt="avatar"/>
														</div>
														<div class="sl-content">
												...
												<a href="javascript:void(0)">
													<div class="sl-item unread-message">
														<div class="sl-avatar avatar avatar-sm avatar-circle">
															<img class="img-responsive img-circle" src="../view/html/img/user4.png" alt="avatar"/>
														</div>
														<div class="sl-content">
												...
												<div class="form-wrap">
													...
													<div class="form-group">
															...
															<div class="input-group">
																...
																<form:input path="firstName" type="text" class="form-control" id="exampleInputuname_1" placeholder="Username"/>
															</div>
														</div>
														
														<div class="form-group">
															<label class="control-label mb-10" for="exampleInputuname_2">Last Name</label>
															<div class="input-group">
																<div class="input-group-addon"><i class="icon-user"></i></div>
																<form:input path="lastName" type="text" class="form-control" id="exampleInputuname_2" placeholder="Username"/>
															</div>
														</div>
														
															<div class="form-group">
															<label class="control-label mb-10" for="exampleInputuname_2">gsmNo</label>
															<div class="input-group">
																<div class="input-group-addon"><i class="icon-user"></i></div>
																<form:input path="gsmNo" type="text" class="form-control" id="exampleInputuname_2" placeholder="Username"/>
															</div>
														</div>

														
														<div class="form-group">
															<label class="control-label mb-10" for="exampleInputuname_2">phone number</label>
															<div class="input-group">
																<div class="input-group-addon"><i class="icon-user"></i></div>
																<form:input path="phoneNo" type="text" class="form-control" id="exampleInputuname_2" placeholder="Username"/>
															</div>
														</div>
														
															<div class="form-group">
															<label class="control-label mb-10" for="exampleInputuname_2">Intercomm Ext</label>
															<div class="input-group">
																<div class="input-group-addon"><i class="icon-user"></i></div>
																<form:input path="intercomExt" type="text" class="form-control" id="exampleInputuname_2" placeholder="Username"/>
															</div>
														</div>
														
														<div class="form-group">
															<label class="control-label mb-10" for="exampleInputuname_2">Program</label>
															<div class="input-group">
																<div class="input-group-addon"><i class="icon-user"></i></div>
																<form:input path="program" type="text" class="form-control" id="exampleInputuname_2" placeholder="Username"/>
															</div>
														</div>
														
														<div class="form-group">
															<label class="control-label mb-10" for="exampleInputuname_2">Department</label>
															<div class="input-group">
																<div class="input-group-addon"><i class="icon-user"></i></div>
																<form:input path="department" type="text" class="form-control" id="exampleInputuname_2" placeholder="Username"/>
															</div>
														</div>
														
														<div class="form-group">
															<label class="control-label mb-10" for="exampleInputuname_2">College</label>
															<div class="input-group">
																<div class="input-group-addon"><i class="icon-user"></i></div>
																<form:input path="college" type="text" class="form-control" id="exampleInputuname_2" placeholder="Username"/>
															</div>
														</div>
														
														<div class="form-group">
															<label class="control-label mb-10" for="exampleInputuname_2">Date</label>
															<div class="input-group">
																<div class="input-group-addon"><i class="icon-user"></i></div>
																<form:input path="date" type="text" class="form-control" id="exampleInputuname_2" placeholder="Username"/>
															</div>
														</div>
         ...
         <td><form:hidden  path="studentMatNo" /></td>
            ...
            <td><input type="submit" value="Edit" class="btn btn-success mr-10"/></td>  
         </tr>  
        </table> 										
		...
		<!-- jQuery -->
		<script src="../view/html/vendors/bower_components/jquery/dist/jquery.min.js"></script>
		
		<!-- Bootstrap Core JavaScript -->
		<script src="../view/html/vendors/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>
		<script src="../view/html/vendors/bower_components/jasny-bootstrap/dist/js/jasny-bootstrap.min.js"></script>
		...
		<!-- Owl JavaScript -->
		<script src="../view/html/vendors/bower_components/owl.carousel/dist/owl.carousel.min.js"></script>
	
		<!-- Switchery JavaScript -->
		<script src="../view/html/vendors/bower_components/switchery/dist/switchery.min.js"></script>
