			...
			<ul class="nav navbar-nav side-nav nicescroll-bar">
				...
				<li>
					...
					<ul id="table_dr" class="collapse collapse-level-1 two-col-list">
						<li>
							<a href="studentData">Student Table</a>
						</li>
						<li>
							<a href="courseData">Course Table</a>
						</li>
						<li>
							<a class="active-page" href="data-table.html">Data Table</a>
						</li>
						<li>
										...
										<div class="table-responsive">
											<table id="datable_1" class="table table-hover display  pb-30" >
												...
												<tbody>
													...
													<tr>
														 <td>${std.studentMatNo}</td>
														
														<td>${std.firstName}</td>
														<td>${std.lastName}</td>
														<td>${std.gsmNo}</td>
														<td>${std.phoneNo}</td>
														<td>${std.intercomExt}</td>
														<td>${std.program}</td>
														...
														<td><a
															href="<c:url value="/editStudent/${std.studentMatNo}" />"> <font color="blue">Edit</font></a></td>
															
														<td><a
															href="<c:url value="/deleteStudent/${std.studentMatNo}" />"> <font color="red">Delete</font></a></td> 
													</tr>
												</c:forEach>
															</tbody>
